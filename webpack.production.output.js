    ...
    splitChunks: {
      ...
      cacheGroups: {
        ...
        components: {
          ...
          test: '/Users/weiyafei/Documents/中国电信/cloud/cloud/src/components',
          minChunks: 3,
          priority: 10,
          reuseExistingChunk: true
        },
        common: {
          name: 'chunk-common',
          test: '/Users/weiyafei/Documents/中国电信/cloud/cloud/src/common',
          minChunks: 3,
          priority: 10,
          reuseExistingChunk: true
        }
    ...
    new DefinePlugin(
      {
        'process.env': {
          ...
          VUE_APP_BUILD_TIME: '"2020-12-2 11:03:54"',
          BASE_URL: '""'
        }
      }
    ),
